    ...
    <div>
      ...
      <div className='2xl:w-[1440px] mx-auto'>
        <div className='pt-[80px]'>
          ...
          At Zella, we are driven by a shared passion for creativity, innovation, and excellence. Our team of designers, developers, and visionaries is dedicated to pushing the boundaries of what's possible, crafting unique and inspired experiences that resonate with our customers and leave a lasting impression. As technology continues to transform the way we live, work, and connect, we are at the forefront of innovation in the e-commerce space. 
          </p>
        </div>
        <div className='flex justify-center'>
          <div className='pt-[24px] gap-[40px] w-[90%] h-[300px] sm:w-[720px] sm:h-[450px] lg:w-[900px] lg:h-[600px] relative'>
            <img
              src='https://t4.ftcdn.net/jpg/05/52/30/19/360_F_552301981_Fmd8TVilDdztHDBnTcp0EMUCWPbgNUBt.jpg'
          ...
          <div className='sm:w-[90%] lg:w-[50%]'>
            ...
            {state === 'Mission' && (
              <p className='manropefont text-justify text-[16px] leading-[24px] sm:text-[18px] sm:leading-[36px] font-[400] text-gray-1000 w-full'>
                At Zella Technologies Limited, our mission is to redefine the experience of gifting and revolutionize e-commerce through innovation, technology, and exceptional service. As an online gift shop and e-commerce platform, we are committed to creating moments of joy, connection, and delight for our customers, while continuously striving to exceed their expectations.
              </p>
            )}
            {state === 'Vision' && (
              <p className='manropefont text-justify text-[16px] leading-[24px] sm:text-[18px] sm:leading-[36px] font-[400] text-gray-1000 w-full'>
                At Zella Technologies Limited, our vision is to become the premier destination for thoughtful gifting and seamless e-commerce experiences worldwide. We aspire to set the standard for innovation, creativity, and customer-centricity in the online gift shop and e-commerce industry.
              </p>
            )}
            ...
            <div className='sm:w-[100%] lg:w-[50%] block lg:hidden mt-[30px]'>
              <div className='w-[100%] h-[248px] sm:h-[400px] lg:w-[400px] lg:h-[400px] xl:w-[500px] xl:h-[400px] relative'>
                <img
                src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSP-vwySy8bYa70va57YFrJahL3gp79Myj7hxB3Pm_X-kVD9joU84Fg6gJjWpMcxWqARdQ&usqp=CAU'
                  alt='green Triangle'
